...
```
figlet curl jq lolcat nmap sudo tcpdump traceroute ss host nslookup mtr tmux aircrack-ng vnstat vnstati randtype speedtest-cli bash zenmap figlet wavemon
```
